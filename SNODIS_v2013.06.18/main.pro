;---------------------------------------------------------------------------------
; $Id: main.pro,v 1.37 2012/12/14 21:06:50 bguan Exp $
...
; domain info.
area='SierraNevada'; name of model domain [single word].
ncols_nldas=38
nrows_nldas=50
ncols_snodis=1140
nrows_snodis=1500
dem_lon_small=-122.372916666667; center longitude of the westernmost pixel [degree].
dem_lat_large=41.3729166666667; center latitude of the northernmost pixel [degree].
dem_pixelsize=0.00416666666666667; [degree]

; constants for IPW elevrad.
refelev=1636.54; reference elevation (elevation of optical depth instrument); here taken as mean elevation of Sierra Nevada [m].
...
undefi=-9999
undefo=-9999
snodis_root='/home/bguan/work/SNODIS/'; root dir of model.
